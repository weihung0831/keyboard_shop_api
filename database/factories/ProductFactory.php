...
<h2>產品特色</h2>
<ul>
    <li>品牌：{$brand}，型號：{$model}</li>
    <li>軸體：{$switch}，提供優質打字體驗</li>
    <li>配置：{$layout}，節省桌面空間</li>
    <li>連接方式：{$connection}</li>
</ul>
<h2>產品說明</h2>
<p>{$brand} {$model} 是一款專為專業用戶設計的機械鍵盤。採用高品質 {$switch}，提供舒適的打字手感。{$layout} 配置既保留常用按鍵，又能有效節省桌面空間。</p>
<h2>包裝內容</h2>
<ul>
    <li>鍵盤本體 x 1</li>
    <li>USB-C 連接線 x 1</li>
...
<h2>產品說明</h2>
<p>{$brand} {$theme} 鍵帽組採用高品質 {$material} 製作，{$profile} 高度設計符合人體工學。精美的 {$theme} 配色方案，讓您的鍵盤更具個人風格。</p>
<h2>相容性</h2>
<p>適用於 Cherry MX 軸體及相容軸體的機械鍵盤。</p>
HTML;
    }
...
<h2>產品說明</h2>
<p>{$brand} {$type} 是一款高品質機械軸體，{$switchType}手感設計。適合追求極致打字體驗的玩家。可用於 DIY 客製化鍵盤或更換現有鍵盤軸體。</p>
<h2>使用建議</h2>
<p>建議搭配適當潤滑油使用，可獲得更順滑的手感體驗。</p>
HTML;
    }
...
<h2>產品說明</h2>
<p>高品質{$typeName}，能有效提升鍵盤的使用體驗。{$brand} 品質保證，是鍵盤愛好者的必備配件。</p>
HTML;
    }
...
<h2>產品說明</h2>
<p>{$brand} {$kit} 是一款高品質客製化鍵盤套件。採用 {$material} 外殼，搭配 {$plate}，提供優異的打字手感與聲音表現。{$layout} 配置適合大多數使用場景。</p>
<h2>注意事項</h2>
<p>本產品為 Barebone 套件，不含軸體與鍵帽，需另行購買。適合有 DIY 經驗的玩家。</p>
<h2>包裝內容</h2>
<ul>
    <li>外殼（上蓋 + 底殼）</li>
    <li>PCB 電路板</li>
